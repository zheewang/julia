...
extern JL_DLLEXPORT jl_datatype_t *jl_condition_type;
#endif
...
//JL_DLLEXPORT jl_task_t *jl_new_task(jl_value_t *args);
JL_DLLEXPORT jl_task_t *jl_task_spawn(jl_value_t *args, int8_t sticky, int8_t detach);
JL_DLLEXPORT jl_value_t *jl_task_sync(jl_task_t *task);
JL_DLLEXPORT jl_task_t *jl_task_parfor(jl_value_t *args, int64_t count, jl_value_t *rargs);
